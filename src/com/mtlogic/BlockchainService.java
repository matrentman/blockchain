...
public class BlockchainService {
	...
	public String invokeRPCWithCloseableHttpClient(String id, String method, List<Object> params) throws Exception {
		...
		try {
			...
			// HttpPost("http://"+"172.31.6.202"+":"+"5762");
	...
	// public JSONObject invokeRPC(String id, String method, List<Object>
	// params) {
	// //DefaultHttpClient httpclient = new DefaultHttpClient(); -- replace with
	// line below
	...
	// JSONObject responseJsonObj = null;
	// try {
	// httpclient.getCredentialsProvider().setCredentials(new AuthScope(ip,
	// port),
